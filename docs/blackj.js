...
function plantarme() {
	...
	info.innerHTML = "Puntuación jugador: " + pointsUser + "<br>Puntuación jugador 2: " + pointsCrupier;
	...
	if (pointsUser == 21) {
		...
		info.innerHTML +="<br><b>Has ganado!!! Jugador 2 se ha pasado de puntos</b>";
	} else if (pointsCrupier >= pointsUser) {
		info.innerHTML += "<br><b>Ha ganado  el jugador 2 </b>";
	} else {
